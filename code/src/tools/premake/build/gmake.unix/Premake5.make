...
ifeq ($(config),release)
  ...
  LIBS += -Wl,--start-group bin/Release/liblua-lib.a bin/Release/libzip-lib.a bin/Release/libzlib-lib.a bin/Release/libcurl-lib.a -lm -ldl -lrt -Wl,--end-group
...
ifeq ($(config),debug)
  ...
  ALL_RESFLAGS += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  LIBS += -Wl,--start-group bin/Debug/liblua-lib.a bin/Debug/libzip-lib.a bin/Debug/libzlib-lib.a bin/Debug/libcurl-lib.a -lm -ldl -lrt -Wl,--end-group
