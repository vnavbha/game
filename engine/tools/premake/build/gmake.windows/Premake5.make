...
ifeq ($(config),release)
  ...
  INCLUDES += -I../../contrib/lua/src -I../../contrib/zlib -I../../contrib/libzip -I../../contrib/curl/include
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
  ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -flto -O3 -Wall -Wextra
  ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CFLAGS) -fno-stack-protector
  ALL_RESFLAGS += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  LIBS += -Wl,--start-group bin/Release/lua-lib.lib bin/Release/zip-lib.lib bin/Release/zlib-lib.lib bin/Release/curl-lib.lib -lole32 -lws2_32 -Wl,--end-group
...
ifeq ($(config),debug)
  ...
  ALL_RESFLAGS += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  LIBS += -Wl,--start-group bin/Debug/lua-lib.lib bin/Debug/zip-lib.lib bin/Debug/zlib-lib.lib bin/Debug/curl-lib.lib -lole32 -lws2_32 -Wl,--end-group
