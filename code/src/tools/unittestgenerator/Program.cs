...
namespace tools.unittestgenerator
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Creating unit test for {0}", args[0]);

            var fullPath = Path.GetFullPath(args[0]);

            Console.WriteLine("Creating unit test for {0}", fullPath);
            ...
            var sourcePath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "unittestgeneratorfiles");
